...
const CarouselComponent: React.FC<Props> = ({ photos = [] }) => {
	...
	return (
		<div className="carousel-wrapper">
			...
			<button type="button" onClick={prevSlide} aria-label="previous" className="carousel-button prev">prev</button>
			<button type="button" onClick={nextSlide} aria-label="next" className="carousel-button next">next</button>
		</div>
	);
};
